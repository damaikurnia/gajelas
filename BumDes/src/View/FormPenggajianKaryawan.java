...
public class FormPenggajianKaryawan extends javax.swing.JFrame {
    ...
    public FormPenggajianKaryawan() {
        try {
            ...
            Logger.getLogger(FormPenggajianKaryawan.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("FORM PENGGAJIAN KARYAWAN BULAN <<BULAN>>");
        ...
        jPanel3.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 270, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormPenggajianKaryawan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormPenggajianKaryawan().setVisible(true);
            }
        });
    }
