...
insert  into `anggota`(`idanggota`,`namaanggota`,`pekerjaan`,`alamat`,`telp`,`noKTP`,`rt`,`rw`,`dusun`,`desa`,`kota`,`provinsi`,`kecamatan`) values ('105314064','Roy','Jual Akik','Jl Paingan','08192231421','3450192210029993',2,1,'Timbulrejo','Depok','Sleman','Yogyakarta','Maguwoharjo');
...
insert  into `pemakaian`(`notransaksi`,`idanggota`,`airlunas`,`airterakhir`,`airdibayar`,`bulan`,`jatuhtempo`) values ('105314064-1','105314064',0,0,0,'MARET','2015-04-10');
...
insert  into `transaksi`(`notransaksi`,`idbarang`,`idanggota`,`tanggaltransaksi`,`jenistransaksi`,`jumlah`,`hargasatuan`,`denda`,`total`) values ('105314064-0','-','105314064','2015-03-19','DAFTAR',1,50000,0,50000),('4613584','BRG1','-','2015-03-02','PEMBELIAN',4,5000,0,20000),('55474511','BRG2','-','2015-03-02','PEMBELIAN',2,10000,0,20000);
