...
insert  into `pemakaian`(`notransaksi`,`idanggota`,`airlunas`,`airterakhir`,`airdibayar`,`bulan`,`jatuhtempo`) values ('105314024-1','105314024',0,20,20,'FEBRUARI','2015-03-10'),('105314024-2','105314024',20,50,30,'MARET','2015-04-10'),('105314064-1','105314064',50,50,0,'MARET','2015-04-10'),('105314066-1','105314066',20,20,0,'MARET','2015-04-10');
...
insert  into `transaksi`(`notransaksi`,`idbarang`,`idanggota`,`tanggaltransaksi`,`jenistransaksi`,`jumlah`,`hargasatuan`,`denda`,`total`) values ('105314024-0','-','105314024','2015-02-24','DAFTAR',1,50000,0,50000),('105314064-0','-','105314064','2015-03-19','DAFTAR',1,50000,0,50000),('105314064-1','-','105314064','2015-03-24','PENJUALAN',50,500,0,25000),('105314066-0','-','105314066','2015-03-23','DAFTAR',1,50000,0,50000),('105314066-1','-','105314066','2015-03-23','PENJUALAN',20,500,0,10000),('4613584','BRG1','-','2015-03-02','PEMBELIAN',4,5000,0,20000),('55474511','BRG2','-','2015-03-02','PEMBELIAN',2,10000,0,20000);
