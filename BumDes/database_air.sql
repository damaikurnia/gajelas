...
insert  into `pemakaian`(`notransaksi`,`idanggota`,`airlunas`,`airterakhir`,`airdibayar`,`bulan`,`tahun`) values ('105314024-1','105314024',150,150,0,'FEBRUARI','2015'),('105314024-2','105314024',150,0,0,'MARET','2015'),('105314044-1','105314044',0,500,500,'MARET','2015'),('105314064-1','105314064',0,0,0,'MARET','2015'),('105314066-1','105314066',0,0,0,'MARET','2015');
...
insert  into `transaksi`(`notransaksi`,`idbarang`,`idanggota`,`tanggaltransaksi`,`jenistransaksi`,`jumlah`,`hargasatuan`,`denda`,`total`) values ('105314024-1','-','105314024','2015-03-16','PENJUALAN',150,500,1500,76500),('4613584','BRG1','-','2015-03-02','PEMBELIAN',4,5000,0,20000),('55474511','BRG2','-','2015-03-02','PEMBELIAN',2,10000,0,20000);
